...
![Version: 0.1.2](https://img.shields.io/badge/Version-0.1.0-informational?style=for-the-badge)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=for-the-badge)
![AppVersion: 0.1.2](https://img.shields.io/badge/AppVersion-0.1.0-informational?style=for-the-badge)
...
| krakend.endpoints.image | object | `{"args":["-c","cp /endpoints.json /endpoints/endpoints.tmpl"],"command":["/bin/sh"],"pullPolicy":"IfNotPresent","registry":null,"repository":null,"tag":null}` | This is the image to use to load the endpoints from. Note that the registry, repository and tag must be set. |
