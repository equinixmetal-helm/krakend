...
![Version: 0.1.19](https://img.shields.io/badge/Version-0.1.19-informational?style=for-the-badge)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=for-the-badge)
![AppVersion: 2.3.3](https://img.shields.io/badge/AppVersion-2.3.3-informational?style=for-the-badge)
...
| image.tag | string | `"2.4.6"` | The image tag to use |
...
| krakend.configFileSource | string, optional | `""` | an external file relative path, will contain the full configuration of the kraken service. useful if config file is generated with flexible config https://www.krakend.io/docs/configuration/flexible-config/ |
